...
module.exports = (app) ->
	...
	app.get		'/api/brew/profile/:profile_id', brew.listByProfile
	app.post	'/api/brew/profile/:profile_id', brew.createByProfile
	...
	app.get 	'/api/diaryEntry/profile/:profile_id', diaryEntry.listByProfile
	app.post 	'/api/diaryEntry/profile/:profile_id', diaryEntry.createByProfile
	app.delete 	'/api/diaryEntry/profile/:profile_id', diaryEntry.destroyByProfile
	...
	app.get 	'/api/recipeItem/recipe/:recipe_id', recipeItem.listByRecipe
	app.post 	'/api/recipeItem/recipe/:recipe_id', recipeItem.createByRecipe
